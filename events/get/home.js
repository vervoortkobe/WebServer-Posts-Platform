    ...
    return res.send(`
      ...
      <body>
        <center><br>
          Not logged in!<br><br>
          <a href="/dlogin">
            <button id="dlogin" class="btn btn-outline-primary">
              <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="discord" class="svg-inline--fa fa-discord fa-lg " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" color="var(--card-color-text)" style="width: 5%; height: auto;">
